...
//                         Get started
//                     </a>
//                     <a href="javascript:void(0)" className="px-10 py-3.5 w-full text-gray-500 text-center border rounded-md duration-300 hover:bg-teal-300 hover:text-indigo-600 hover:shadow block sm:w-auto">
//                         Try it out
//                     </a>
//                 </div>
//             </section>
